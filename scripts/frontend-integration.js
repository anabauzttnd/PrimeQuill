 ...
 * This file demonstrates how to integrate Primequill with a web frontend
 */

// For React/Vue/Angular applications
export class PrimequillClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PrimequillClient(provider, contractAddress);
